...
import static org.telegramIunzhakov.messenger.AndroidUtilities.isInAirplaneMode;
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case VIEW_TYPE_SHADOW:
                    ...
                    Drawable shadowDrawable = Theme.getThemedDrawable(getContext(), org.telegramIunzhakov.messenger.R.drawable.greydivider, Theme.getColor(Theme.key_windowBackgroundGrayShadow, resourceProvider));
        ...
        listView.setOnItemClickListener((view, position) -> {
            ...
            if (item.viewType == VIEW_TYPE_HEADER) {
                ...
                try {
                    ...
                    builder.setNegativeButton(LocaleController.getString("Cancel", org.telegramIunzhakov.messenger.R.string.Cancel), null);
