...
import org.telegramIunzhakov.ui.web.HttpGetFileTask;
import org.telegramIunzhakov.ui.web.HttpGetTask;
...
public class BetaUpdaterController {
    ...
    public void checkForUpdate(boolean force, Runnable whenDone) {
        ...
        final String url = org.telegramIunzhakov.messenger.BuildConfig.BETA_URL;
