...
public class ApplicationLoaderImpl extends ApplicationLoader {
    ...
    protected void startAppCenterInternal(Activity context) {
        if (org.telegramIunzhakov.messenger.BuildConfig.DEBUG) {
            return;
        }
        try {
            ...
            if (BuildVars.DEBUG_VERSION) {
                ...
                String appHash = org.telegramIunzhakov.messenger.BuildConfig.APP_CENTER_HASH;
...
//        }
    ...
    public boolean isCustomUpdate() {
        return !TextUtils.isEmpty(org.telegramIunzhakov.messenger.BuildConfig.BETA_URL);
    }
