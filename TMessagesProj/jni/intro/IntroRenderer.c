...
static TexturedShape telegramIunzhakov_sphere, telegramIunzhakov_plane, telegramIunzhakov_mask;
...
static GLuint telegramIunzhakov_sphere_texture, telegramIunzhakov_plane_texture, telegramIunzhakov_mask_texture;
...
JNIEXPORT void Java_org_telegramIunzhakov_messenger_Intro_setBackgroundColor(JNIEnv *env, jclass class, jfloat r, jfloat g, jfloat b, jfloat a) {
    ...
    telegramIunzhakov_mask = create_textured_rectangle(CSizeMake(200, 150), telegramIunzhakov_mask_texture);
}

JNIEXPORT void Java_org_telegramIunzhakov_messenger_Intro_onDrawFrame(JNIEnv *env, jclass class, jint deltaMs) {
    if (surfaceCreated == 0) {
    ...
    if (current_page == 0) {
        ...
        telegramIunzhakov_sphere.params.alpha = 1;
        ...
        telegramIunzhakov_sphere.params.alpha = alpha;
        telegramIunzhakov_sphere.params.scale = xyzMake(scale, scale, 1);

        telegramIunzhakov_plane.params.alpha = 1;
        ...
        telegramIunzhakov_plane.params.position = xyzMake(dx, dy, 0);

        float scale = (cosf(tt) + 1) * 0.5f;

        telegramIunzhakov_plane.params.scale = xyzMake(cosf(tt) * scale, scale, 1);
    ...
    if (current_page == 0) {
        rglNormalDraw();
        if (direct == 0) {
            telegramIunzhakov_sphere.params.alpha = t(0, 1, 0, duration_const * 0.8f, Linear);
            scale = 1;

            telegramIunzhakov_sphere.params.scale = xyzMake(scale, scale, 1);
            draw_textured_shape(&telegramIunzhakov_sphere, main_matrix, NORMAL);
            ...
            telegramIunzhakov_plane.params.scale = xyzMake(scale, scale, 1);

            if (tt < D2R(125)) {
                glBlendFunc(GL_ONE, GL_ONE_MINUS_SRC_ALPHA);
                draw_textured_shape(&telegramIunzhakov_plane, main_matrix, NORMAL_ONE);
                draw_textured_shape(&telegramIunzhakov_mask, main_matrix, NORMAL);
            }
        }
    } else if (current_page == 1) {
        rglNormalDraw();
        if (direct == 1) {
            telegramIunzhakov_sphere.params.alpha = t(1, 0, 0, duration_const, Linear);
            draw_textured_shape(&telegramIunzhakov_sphere, main_matrix, NORMAL);
...
JNIEXPORT void Java_org_telegramIunzhakov_messenger_Intro_setScrollOffset(JNIEnv *env, jclass class, float a_offset) {
    scroll_offset = a_offset;
}

JNIEXPORT void Java_org_telegramIunzhakov_messenger_Intro_setPage(JNIEnv *env, jclass class, int32_t page) {
...
JNIEXPORT void Java_org_telegramIunzhakov_messenger_Intro_setDate(JNIEnv *env, jclass class, float a) {
    date = a;
}

JNIEXPORT void Java_org_telegramIunzhakov_messenger_Intro_setIcTextures(JNIEnv *env, jclass class, GLuint a_ic_bubble_dot, GLuint a_ic_bubble, GLuint a_ic_cam_lens, GLuint a_ic_cam, GLuint a_ic_pencil, GLuint a_ic_pin, GLuint a_ic_smile_eye, GLuint a_ic_smile, GLuint a_ic_videocam) {
...
JNIEXPORT void Java_org_telegramIunzhakov_messenger_Intro_setTelegramTextures(JNIEnv *env, jclass class, GLuint a_telegramIunzhakov_sphere, GLuint a_telegramIunzhakov_plane, GLuint a_telegramIunzhakov_mask) {
    telegramIunzhakov_sphere_texture = a_telegramIunzhakov_sphere;
    telegramIunzhakov_plane_texture = a_telegramIunzhakov_plane;
    telegramIunzhakov_mask_texture = a_telegramIunzhakov_mask;
}

JNIEXPORT void Java_org_telegramIunzhakov_messenger_Intro_setFastTextures(JNIEnv *env, jclass class, GLuint a_fast_body, GLuint a_fast_spiral, GLuint a_fast_arrow, GLuint a_fast_arrow_shadow) {
...
JNIEXPORT void Java_org_telegramIunzhakov_messenger_Intro_setFreeTextures(JNIEnv *env, jclass class, GLuint a_knot_up, GLuint a_knot_down) {
    free_knot_up_texture = a_knot_up;
    free_knot_down_texture = a_knot_down;
}

JNIEXPORT void Java_org_telegramIunzhakov_messenger_Intro_setPowerfulTextures(JNIEnv *env, jclass class, GLuint a_powerful_mask, GLuint a_powerful_star, GLuint a_powerful_infinity, GLuint a_powerful_infinity_white) {
...
JNIEXPORT void Java_org_telegramIunzhakov_messenger_Intro_setPrivateTextures(JNIEnv *env, jclass class, GLuint a_private_door, GLuint a_private_screw) {
    private_door_texture = a_private_door;
    private_screw_texture = a_private_screw;
}

JNIEXPORT void Java_org_telegramIunzhakov_messenger_Intro_onSurfaceCreated(JNIEnv *env, jclass class) {
    ...
    telegramIunzhakov_sphere = create_textured_rectangle(CSizeMake(150, 150), telegramIunzhakov_sphere_texture);
    telegramIunzhakov_mask = create_textured_rectangle(CSizeMake(200, 150), telegramIunzhakov_mask_texture);
    telegramIunzhakov_plane = create_textured_rectangle(CSizeMake(82, 74), telegramIunzhakov_plane_texture);
    telegramIunzhakov_plane.params.anchor = xyzMake(6, -5, 0);
...
JNIEXPORT void Java_org_telegramIunzhakov_messenger_Intro_onSurfaceChanged(JNIEnv *env, jclass class, int32_t a_width_px, int32_t a_height_px, float a_scale_factor, int32_t a1) {
