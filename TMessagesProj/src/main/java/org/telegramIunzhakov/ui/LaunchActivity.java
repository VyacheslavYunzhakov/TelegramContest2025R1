...
import static org.telegramIunzhakov.ui.Components.Premium.LimitReachedBottomSheet.TYPE_ACCOUNTS;
import static org.telegramIunzhakov.ui.Components.Premium.LimitReachedBottomSheet.TYPE_BOOSTS_FOR_USERS;
...
import org.telegramIunzhakov.messenger.AutoDeleteMediaTask;
import org.telegramIunzhakov.messenger.BackupAgent;
import org.telegramIunzhakov.messenger.BetaUpdate;
import org.telegramIunzhakov.messenger.BotWebViewVibrationEffect;
import org.telegramIunzhakov.messenger.BuildVars;
import org.telegramIunzhakov.messenger.ChannelBoostsController;
import org.telegramIunzhakov.messenger.ChatObject;
import org.telegramIunzhakov.messenger.ContactsController;
import org.telegramIunzhakov.messenger.ContactsLoadingObserver;
...
import org.telegramIunzhakov.messenger.FingerprintController;
import org.telegramIunzhakov.messenger.FlagSecureReason;
import org.telegramIunzhakov.messenger.GenericProvider;
...
import org.telegramIunzhakov.messenger.OpenAttachedMenuBotReceiver;
import org.telegramIunzhakov.messenger.PushListenerController;
...
import org.telegramIunzhakov.messenger.SharedPrefsHelper;
import org.telegramIunzhakov.messenger.TopicsController;
...
import org.telegramIunzhakov.messenger.pip.activity.IPipActivity;
import org.telegramIunzhakov.messenger.pip.activity.IPipActivityHandler;
import org.telegramIunzhakov.messenger.pip.activity.IPipActivityListener;
import org.telegramIunzhakov.messenger.voip.VideoCapturerDevice;
import org.telegramIunzhakov.messenger.voip.VoIPGroupNotification;
import org.telegramIunzhakov.messenger.voip.VoIPPendingCall;
import org.telegramIunzhakov.messenger.voip.VoIPPreNotificationService;
import org.telegramIunzhakov.messenger.voip.VoIPService;
...
import org.telegramIunzhakov.ui.ActionBar.ActionBarLayout;
import org.telegramIunzhakov.ui.ActionBar.AlertDialog;
import org.telegramIunzhakov.ui.ActionBar.BaseFragment;
import org.telegramIunzhakov.ui.ActionBar.BottomSheetTabs;
import org.telegramIunzhakov.ui.ActionBar.BottomSheetTabsOverlay;
import org.telegramIunzhakov.ui.ActionBar.DrawerLayoutContainer;
import org.telegramIunzhakov.ui.ActionBar.INavigationLayout;
import org.telegramIunzhakov.ui.ActionBar.Theme;
import org.telegramIunzhakov.ui.Adapters.DrawerLayoutAdapter;
import org.telegramIunzhakov.ui.Cells.ChatMessageCell;
import org.telegramIunzhakov.ui.Cells.DrawerActionCell;
import org.telegramIunzhakov.ui.Cells.DrawerAddCell;
import org.telegramIunzhakov.ui.Cells.DrawerProfileCell;
import org.telegramIunzhakov.ui.Cells.DrawerUserCell;
import org.telegramIunzhakov.ui.Cells.LanguageCell;
import org.telegramIunzhakov.ui.Components.AlertsCreator;
import org.telegramIunzhakov.ui.Components.AnimatedEmojiDrawable;
import org.telegramIunzhakov.ui.Components.AppIconBulletinLayout;
import org.telegramIunzhakov.ui.Components.AttachBotIntroTopView;
import org.telegramIunzhakov.ui.Components.AudioPlayerAlert;
import org.telegramIunzhakov.ui.Components.BatteryDrawable;
import org.telegramIunzhakov.ui.Components.BlockingUpdateView;
...
import org.telegramIunzhakov.ui.Components.Easings;
import org.telegramIunzhakov.ui.Components.EmbedBottomSheet;
import org.telegramIunzhakov.ui.Components.EmojiPacksAlert;
import org.telegramIunzhakov.ui.Components.FireworksOverlay;
import org.telegramIunzhakov.ui.Components.FloatingDebug.FloatingDebugController;
import org.telegramIunzhakov.ui.Components.FolderBottomSheet;
import org.telegramIunzhakov.ui.Components.Forum.ForumUtilities;
import org.telegramIunzhakov.ui.Components.GroupCallPip;
...
import org.telegramIunzhakov.ui.Components.PasscodeView;
import org.telegramIunzhakov.ui.Components.PasscodeViewDialog;
import org.telegramIunzhakov.ui.Components.PhonebookShareAlert;
import org.telegramIunzhakov.ui.Components.PipRoundVideoView;
import org.telegramIunzhakov.ui.Components.PipVideoOverlay;
import org.telegramIunzhakov.ui.Components.Premium.LimitReachedBottomSheet;
import org.telegramIunzhakov.ui.Components.Premium.boosts.BoostPagerBottomSheet;
import org.telegramIunzhakov.ui.Components.Premium.boosts.GiftInfoBottomSheet;
...
import org.telegramIunzhakov.ui.Components.SearchTagsList;
import org.telegramIunzhakov.ui.Components.SharingLocationsAlert;
import org.telegramIunzhakov.ui.Components.SideMenultItemAnimator;
import org.telegramIunzhakov.ui.Components.SizeNotifierFrameLayout;
import org.telegramIunzhakov.ui.Components.StickerSetBulletinLayout;
import org.telegramIunzhakov.ui.Components.StickersAlert;
import org.telegramIunzhakov.ui.Components.TermsOfServiceView;
import org.telegramIunzhakov.ui.Components.ThemeEditorView;
import org.telegramIunzhakov.ui.Components.UndoView;
import org.telegramIunzhakov.ui.Components.spoilers.SpoilerEffect2;
import org.telegramIunzhakov.ui.Components.voip.RTMPStreamPipOverlay;
import org.telegramIunzhakov.ui.Components.voip.VoIPHelper;
import org.telegramIunzhakov.ui.Stars.ISuperRipple;
...
import org.telegramIunzhakov.ui.Stars.SuperRipple;
import org.telegramIunzhakov.ui.Stars.SuperRippleFallback;
...
import org.telegramIunzhakov.ui.bots.BotWebViewSheet;
import org.telegramIunzhakov.ui.bots.WebViewRequestProps;
...
//            dismissAllWeb();
        ...
        if ((flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
            if (intent != null && intent.getAction() != null && !restore) {
                ...
                } else if ("org.telegramIunzhakov.messenger.CREATE_STICKER_PACK".equals(intent.getAction())) {
                    try {
...
//                                                storyId = Utilities.parseInt(data.getQueryParameter("story"));
                                ...
                                try (Cursor cursor = getContentResolver().query(intent.getData(), null, null, null, null)) {
                                    if (cursor != null) {
                                        if (cursor.moveToFirst()) {
                                            ...
                                            if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.org.telegramIunzhakov.messenger.android.call")) {
                                                audioCallUser = true;
                                            } else if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.org.telegramIunzhakov.messenger.android.call.video")) {
                                                videoCallUser = true;
                                            }
                                        }
                                    }
                ...
                } else if (intent.getAction().equals("org.telegramIunzhakov.messenger.OPEN_ACCOUNT")) {
                    open_settings = 1;
