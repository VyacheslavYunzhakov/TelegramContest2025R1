...
import static org.telegramIunzhakov.messenger.AndroidUtilities.displayMetrics;
...
import static org.telegramIunzhakov.messenger.ContactsController.PRIVACY_RULES_TYPE_ADDED_BY_PHONE;
...
import org.telegramIunzhakov.PhoneFormat.PhoneFormat;
...
import org.telegramIunzhakov.messenger.AuthTokensHelper;
import org.telegramIunzhakov.messenger.BillingController;
import org.telegramIunzhakov.messenger.BirthdayController;
...
import org.telegramIunzhakov.messenger.FlagSecureReason;
...
import org.telegramIunzhakov.messenger.LanguageDetector;
...
import org.telegramIunzhakov.messenger.NotificationsController;
...
import org.telegramIunzhakov.tgnet.tl.TL_fragment;
...
import org.telegramIunzhakov.ui.ActionBar.ActionBarMenu;
import org.telegramIunzhakov.ui.ActionBar.ActionBarMenuItem;
import org.telegramIunzhakov.ui.ActionBar.ActionBarMenuSubItem;
import org.telegramIunzhakov.ui.ActionBar.ActionBarPopupWindow;
...
import org.telegramIunzhakov.ui.ActionBar.ThemeDescription;
import org.telegramIunzhakov.ui.Business.OpeningHoursActivity;
import org.telegramIunzhakov.ui.Business.ProfileHoursCell;
import org.telegramIunzhakov.ui.Business.ProfileLocationCell;
import org.telegramIunzhakov.ui.Cells.AboutLinkCell;
import org.telegramIunzhakov.ui.Cells.CheckBoxCell;
import org.telegramIunzhakov.ui.Cells.DividerCell;
import org.telegramIunzhakov.ui.Cells.DrawerProfileCell;
import org.telegramIunzhakov.ui.Cells.GraySectionCell;
import org.telegramIunzhakov.ui.Cells.HeaderCell;
import org.telegramIunzhakov.ui.Cells.NotificationsCheckCell;
import org.telegramIunzhakov.ui.Cells.ProfileChannelCell;
import org.telegramIunzhakov.ui.Cells.SettingsSearchCell;
import org.telegramIunzhakov.ui.Cells.SettingsSuggestionCell;
import org.telegramIunzhakov.ui.Cells.ShadowSectionCell;
import org.telegramIunzhakov.ui.Cells.TextCell;
import org.telegramIunzhakov.ui.Cells.TextCheckCell;
import org.telegramIunzhakov.ui.Cells.TextDetailCell;
import org.telegramIunzhakov.ui.Cells.TextInfoPrivacyCell;
import org.telegramIunzhakov.ui.Cells.UserCell;
import org.telegramIunzhakov.ui.Components.AlertsCreator;
import org.telegramIunzhakov.ui.Components.AnimatedColor;
...
import org.telegramIunzhakov.ui.Components.AnimatedFileDrawable;
import org.telegramIunzhakov.ui.Components.AnimatedFloat;
import org.telegramIunzhakov.ui.Components.AnimatedTextView;
import org.telegramIunzhakov.ui.Components.AnimationProperties;
import org.telegramIunzhakov.ui.Components.AudioPlayerAlert;
import org.telegramIunzhakov.ui.Components.AutoDeletePopupWrapper;
import org.telegramIunzhakov.ui.Components.AvatarDrawable;
import org.telegramIunzhakov.ui.Components.BackButtonMenu;
import org.telegramIunzhakov.ui.Components.BackupImageView;
import org.telegramIunzhakov.ui.Components.Bulletin;
import org.telegramIunzhakov.ui.Components.BulletinFactory;
import org.telegramIunzhakov.ui.Components.ButtonBounce;
import org.telegramIunzhakov.ui.Components.CanvasButton;
...
import org.telegramIunzhakov.ui.Components.DotDividerSpan;
import org.telegramIunzhakov.ui.Components.EmojiPacksAlert;
import org.telegramIunzhakov.ui.Components.EmptyStubSpan;
import org.telegramIunzhakov.ui.Components.FloatingDebug.FloatingDebugController;
import org.telegramIunzhakov.ui.Components.Forum.ForumUtilities;
import org.telegramIunzhakov.ui.Components.FragmentContextView;
import org.telegramIunzhakov.ui.Components.HintView;
import org.telegramIunzhakov.ui.Components.IdenticonDrawable;
import org.telegramIunzhakov.ui.Components.ImageUpdater;
import org.telegramIunzhakov.ui.Components.InstantCameraView;
import org.telegramIunzhakov.ui.Components.ItemOptions;
import org.telegramIunzhakov.ui.Components.JoinGroupAlert;
import org.telegramIunzhakov.ui.Components.LayoutHelper;
import org.telegramIunzhakov.ui.Components.LinkSpanDrawable;
import org.telegramIunzhakov.ui.Components.MediaActivity;
import org.telegramIunzhakov.ui.Components.MessagePrivateSeenView;
import org.telegramIunzhakov.ui.Components.Paint.PersistColorPalette;
import org.telegramIunzhakov.ui.Components.Premium.LimitReachedBottomSheet;
...
import org.telegramIunzhakov.ui.Components.Premium.PremiumPreviewBottomSheet;
import org.telegramIunzhakov.ui.Components.Premium.ProfilePremiumCell;
import org.telegramIunzhakov.ui.Components.Premium.boosts.UserSelectorBottomSheet;
import org.telegramIunzhakov.ui.Components.ProfileGalleryView;
import org.telegramIunzhakov.ui.Components.RLottieDrawable;
import org.telegramIunzhakov.ui.Components.RLottieImageView;
...
import org.telegramIunzhakov.ui.Components.ScamDrawable;
import org.telegramIunzhakov.ui.Components.ShareAlert;
import org.telegramIunzhakov.ui.Components.SharedMediaLayout;
import org.telegramIunzhakov.ui.Components.SizeNotifierFrameLayout;
import org.telegramIunzhakov.ui.Components.StickerEmptyView;
import org.telegramIunzhakov.ui.Components.TimerDrawable;
import org.telegramIunzhakov.ui.Components.TranslateAlert2;
import org.telegramIunzhakov.ui.Components.TypefaceSpan;
import org.telegramIunzhakov.ui.Components.UndoView;
import org.telegramIunzhakov.ui.Components.VectorAvatarThumbDrawable;
import org.telegramIunzhakov.ui.Components.voip.VoIPHelper;
import org.telegramIunzhakov.ui.Gifts.GiftSheet;
import org.telegramIunzhakov.ui.Stars.BotStarsActivity;
import org.telegramIunzhakov.ui.Stars.BotStarsController;
import org.telegramIunzhakov.ui.Stars.ProfileGiftsView;
import org.telegramIunzhakov.ui.Stars.StarGiftPatterns;
...
import org.telegramIunzhakov.ui.Stories.ProfileStoriesView;
import org.telegramIunzhakov.ui.Stories.StoriesController;
import org.telegramIunzhakov.ui.Stories.StoriesListPlaceProvider;
import org.telegramIunzhakov.ui.Stories.StoryViewer;
...
import org.telegramIunzhakov.ui.bots.BotLocation;
import org.telegramIunzhakov.ui.bots.BotWebViewAttachedSheet;
import org.telegramIunzhakov.ui.bots.ChannelAffiliateProgramsFragment;
import org.telegramIunzhakov.ui.bots.SetupEmojiStatusSheet;
...
public class ProfileActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate, SharedMediaLayout.SharedMediaPreloaderDelegate, ImageUpdater.ImageUpdaterDelegate, SharedMediaLayout.Delegate {
    ...
    public View createView(Context context) {
        ...
        extraHeight = AndroidUtilities.dp(EXTRA_HEIGHT);
...
//                    args.putString("addToGroupAlertString", LocaleController.formatString("AddToTheGroupAlertText", R.string.AddToTheGroupAlertText, UserObject.getUserName(user), "%1$s"));
                    ...
                    builder.setPositiveButton(LocaleController.getString(R.string.Delete), (dialogInterface, i) -> {
                        ...
                        if (avatar != null && position == 0) {
                            ...
                            allowPullingDown = !AndroidUtilities.isTablet() && !isInLandscapeMode && avatarImage.getImageReceiver().hasNotThumbForPullingDownCheck() && !AndroidUtilities.isAccessibilityScreenReaderEnabled();
                            avatar = null;
                            avatarBig = null;
        ...
        fragmentView = new NestedFrameLayout(context) {
            ...
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                if (lastMeasuredContentWidth != getMeasuredWidth() || lastMeasuredContentHeight != getMeasuredHeight()) {
                    ...
                    if (emptyView != null) {
                        ((LayoutParams) emptyView.getLayoutParams()).topMargin = AndroidUtilities.dp(EXTRA_HEIGHT) + AndroidUtilities.statusBarHeight;
                    }
                }
                ...
                if (!fragmentOpened && (expandPhoto || openAnimationInProgress && playProfileAnimation == 2)) {
                    ...
                    if (isInLandscapeMode) {
                        paddingTop = AndroidUtilities.dp(EXTRA_HEIGHT);
                        paddingBottom = 0;
                    } else {
                        paddingTop = listView.getMeasuredWidth();
                        paddingBottom = Math.max(0, getMeasuredHeight() - (listContentHeight + AndroidUtilities.dp(EXTRA_HEIGHT) + actionBarHeight));
                    }
                    if (banFromGroup != 0) {
                    ...
                    if ((actionBar.isSearchFieldVisible() || openSimilar) && sharedMediaRow >= 0) {
                        ...
                        if (savedScrollPosition >= 0) {
                            ...
                            if (pos == 0 && !allowPullingDown && top > AndroidUtilities.dp(EXTRA_HEIGHT)) {
                                top = AndroidUtilities.dp(EXTRA_HEIGHT);
                            }
                            layoutManager.scrollToPositionWithOffset(pos, top - paddingTop);
                            layout = true;
                        } else {
                            layoutManager.scrollToPositionWithOffset(0, AndroidUtilities.dp(EXTRA_HEIGHT) - paddingTop);
                        }
                    }
        ...
        layoutManager = new LinearLayoutManager(context) {
            ...
            public int scrollVerticallyBy(int dy, RecyclerView.Recycler recycler, RecyclerView.State state) {
                ...
                if (view != null && !openingAvatar) {
                    final int canScroll = view.getTop() - AndroidUtilities.dp(EXTRA_HEIGHT);
                    if (!allowPullingDown && canScroll > dy) {
                        dy = canScroll;
                        if (avatarsViewPager.hasImages() && avatarImage.getImageReceiver().hasNotThumbForPullingDownCheck() && !AndroidUtilities.isAccessibilityScreenReaderEnabled() && !isInLandscapeMode && !AndroidUtilities.isTablet()) {
        ...
        if (banFromGroup != 0) {
            ...
            listView.setPadding(0, AndroidUtilities.dp(EXTRA_HEIGHT), 0, AndroidUtilities.dp(48));
            listView.setBottomGlowOffset(AndroidUtilities.dp(48));
        } else {
            listView.setPadding(0, AndroidUtilities.dp(EXTRA_HEIGHT), 0, 0);
        }
...
//                initialTitleWidth = (int) (avatarContainer.getTitleTextView().getWidth() / AndroidUtilities.density);
        ...
        for (int a = 0; a < nameTextView.length; a++) {
            ...
            avatarContainer2.addView(nameTextView[a], LayoutHelper.createFrame(a == 0 ? initialTitleWidth : LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.LEFT | Gravity.TOP, TEXTS_LEFT_MARGIN, -6, (a == 0 ? rightMargin - (hasTitleExpanded ? 10 : 0) : 0), 0));
        }
        for (int a = 0; a < onlineTextView.length; a++) {
            ...
            avatarContainer2.addView(onlineTextView[a], LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.LEFT | Gravity.TOP, TEXTS_LEFT_MARGIN - (a == 1 || a == 2 || a == 3? 4 : 0), (a == 1 || a == 2 || a == 3 ? -2 : 0), (a == 0 ? rightMargin - (hasTitleExpanded ? 10 : 0) : 8) - (a == 1 || a == 2 || a == 3 ? 4 : 0), 0));
        }
        checkPhotoDescriptionAlpha();
        ...
        avatarContainer2.addView(mediaCounterTextView, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.LEFT | Gravity.TOP, TEXTS_LEFT_MARGIN, -2, 8, 0));
    ...
    public void setupButtonsContainer(List<ButtonData> allButtons) {
        ...
        horizontalLayoutParams.setMargins(margin - buttonMargin, margin, margin - buttonMargin, margin);
        ...
        for (ButtonData buttonData : buttonsToShow) {
            ProfileButton button = new ProfileButton(buttonsContainer.getContext(), buttonData, BUTTONS_CONTAINER_SIZE - 14*2);
    ...
    private void muteAction() {
        ...
        boolean muted = getMessagesController().isDialogMuted(did, topicId);
        ProfileButton muteButton = findMuteButton();
        if(!muted && muteButton != null) {
            chatNotificationsPopupWrapper = new ChatNotificationsPopupWrapper(ProfileActivity.this.getContext(), currentAccount, null, true, true, new ChatNotificationsPopupWrapper.Callback() {
                @Override
                ...
                public void toggleMute() {
                    updateExceptions();
                    ProfileActivity.this.toggleMute(muteButton);
                }
            ...
            float x = muteButton.getX();
            float y = muteButton.getY();
            ...
            chatNotificationsPopupWrapper.showAsOptions(ProfileActivity.this, muteButton, x, y);
            } else {
                toggleMute(muteButton);
        }
    }

    private void toggleMute(ProfileButton muteButton) {
        final long did;
        if (dialogId != 0) {
            did = dialogId;
        } else if (userId != 0) {
    ...
    private ProfileButton findMuteButton() {
    ...
    private void updateBottomButtonY() {
        ...
        bottomButtonsContainer.setTranslationY(sharedMediaLayout != null && sharedMediaLayout.isAttachedToWindow() ? Math.max(0, dp(72 + AVATAR_LEFT_MARGIN + 48) - (listView.getMeasuredHeight() - sharedMediaLayout.getY())) : dp(72));
    ...
    private void collapseAvatarInstant() {
        if (allowPullingDown && currentExpandAnimatorValue > 0) {
            layoutManager.scrollToPositionWithOffset(0, AndroidUtilities.dp(EXTRA_HEIGHT) - listView.getPaddingTop());
            listView.post(() -> {
                needLayout(true);
    ...
    private boolean expandAvatar() {
        if (!AndroidUtilities.isTablet() && !isInLandscapeMode && avatarImage.getImageReceiver().hasNotThumbForPullingDownCheck() && !AndroidUtilities.isAccessibilityScreenReaderEnabled()) {
            openingAvatar = true;
            allowPullingDown = true;
            View child = null;
            for (int i = 0; i < listView.getChildCount(); i++) {
    ...
    private void setAvatarExpandProgress(float animatedFracture) {
        ...
        if (extraHeight > AndroidUtilities.dp(EXTRA_HEIGHT) && expandProgress < 0.20f) {
        ...
        final float nameTextViewYEnd = newTop + extraHeight - AndroidUtilities.dpf2(20f) - nameTextView[1].getBottom() - (isSettings() ? AndroidUtilities.dpf2(18f) :dp (BUTTONS_CONTAINER_SIZE));
        ...
        final float onlineTextViewYEnd = newTop + extraHeight - onlineTextView[1].getBottom() - (isSettings() ? AndroidUtilities.dpf2(18f) :dp (BUTTONS_CONTAINER_SIZE));
        ...
        params.width = (int) AndroidUtilities.lerp(AndroidUtilities.dpf2(START_AVATAR_SIZE), listView.getMeasuredWidth() / avatarScale, value);
        params.height = (int) AndroidUtilities.lerp(AndroidUtilities.dpf2(START_AVATAR_SIZE), (extraHeight + newTop) / avatarScale, value);
        params.leftMargin = (int) AndroidUtilities.lerp(AndroidUtilities.dpf2(AVATAR_LEFT_MARGIN), 0f, value);
    ...
    private void expandAvatarToViewPager() {
        ...
        if (allowPullingDown && (openingAvatar || expandProgress >= 0.20f)) {
            ...
            if (!expandAnimator.isRunning()) {
                ...
                nameTextView[1].setTranslationY(newTop + h - AndroidUtilities.dpf2(20f) - nameTextView[1].getBottom() + additionalTranslationY - (isSettings() ? AndroidUtilities.dpf2(18f) :dp (BUTTONS_CONTAINER_SIZE)));
                onlineTextView[1].setTranslationX(AndroidUtilities.dpf2(16f) - onlineTextView[1].getLeft());
                onlineTextView[1].setTranslationY(newTop + h  - onlineTextView[1].getBottom() + additionalTranslationY - (isSettings() ? AndroidUtilities.dpf2(18f) :dp (BUTTONS_CONTAINER_SIZE)));
...
//                                otherItem.showSubItem(edit_name);
    ...
    private void needLayout(boolean animated) {
        ...
        if (avatarContainer != null) {
            ...
            listView.setOverScrollMode(extraHeight > AndroidUtilities.dp(EXTRA_HEIGHT) && extraHeight < listView.getMeasuredWidth() - newTop ? View.OVER_SCROLL_NEVER : View.OVER_SCROLL_ALWAYS);

            adjustWriteButton(animated);
            float yAdjustmentFixated = AndroidUtilities.dp(7.5f) * (1 - diff);
            ...
            avatarY = viewTop - yAdjustmentFixated;
            ...
            if (openAnimationInProgress && playProfileAnimation == 2) {
                ...
                avatarScale = AndroidUtilities.lerp(1.0f, (START_AVATAR_SIZE + START_AVATAR_SIZE + 18f) / START_AVATAR_SIZE, avatarAnimationProgress);
                if (storyView != null) {
                    storyView.setExpandProgress(1f);
                }
                if (giftsView != null) {
                ...
                final FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) avatarContainer.getLayoutParams();
                params.width = params.height = (int) AndroidUtilities.lerp(AndroidUtilities.dpf2(START_AVATAR_SIZE), (extraHeight + newTop) / avatarScale, avatarAnimationProgress);
                params.leftMargin = (int) AndroidUtilities.lerp(AndroidUtilities.dpf2(AVATAR_LEFT_MARGIN), 0f, avatarAnimationProgress);
                avatarContainer.requestLayout();
    ...
    private void adjustWriteButton(Boolean animated) {
        float diff = Math.min(1f, extraHeight / AndroidUtilities.dp(EXTRA_HEIGHT));
        if (writeButton != null) {
    ...
    private void adjustButtonContainer() {
        ...
        if (buttonsContainer != null) {
            ...
            if (availableSpace < 0) {
                ...
                targetHeight = Math.min(dp(BUTTONS_CONTAINER_SIZE), availableSpace);
            }
            layoutParams.height = (int) Math.max(0, targetHeight);
            buttonsContainer.setLayoutParams(layoutParams);
            buttonsContainer.setTranslationY(Math.max(newTop + extraHeight - layoutParams.height, onlineBottom));
            float alpha = targetHeight / dp(BUTTONS_CONTAINER_SIZE);
            buttonsContainer.setAlpha(Math.min(1, Math.max(0, alpha)));
    ...
    public void updateQrItemVisibility(boolean animated) {
        ...
        boolean setQrVisible = isQrNeedVisible() && Math.min(1f, extraHeight / AndroidUtilities.dp(EXTRA_HEIGHT)) > .5f && searchTransitionProgress > .5f;
        if (animated) {
...
//        onlineY = nameY + AndroidUtilities.dp(24) * nameScale;
    ...
    private void needLayoutText(float diff) {
        ...
        float maxScale = extraHeight > AndroidUtilities.dp(EXTRA_HEIGHT) ? 1.67f : 1.36f;

        if (extraHeight > AndroidUtilities.dp(EXTRA_HEIGHT) && scale != maxScale) {
            return;
        }
        ...
        int buttonsWidth = AndroidUtilities.dp(TEXTS_LEFT_MARGIN + 8 + (40 + extra * (1.0f - mediaHeaderAnimationProgress)));
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (isInLandscapeMode && isPulledDown) {
            final View view = layoutManager.findViewByPosition(0);
            if (view != null) {
                listView.scrollBy(0, view.getTop() - AndroidUtilities.dp(EXTRA_HEIGHT));
            }
        }
        fixLayout();
    }
    ...
    public AnimatorSet onCustomTransitionAnimation(final boolean isOpen, final Runnable callback) {
        if (playProfileAnimation != 0 && allowProfileAnimation && !isPulledDown && !disableProfileAnimation) {
            ...
            if (isOpen) {
                ...
                if (playProfileAnimation != 2) {
                    int width = (int) Math.ceil(AndroidUtilities.displaySize.x - AndroidUtilities.dp(TEXTS_LEFT_MARGIN + 8) + 21 * AndroidUtilities.density);
                    ...
                    initialAnimationExtraHeight = AndroidUtilities.dp(EXTRA_HEIGHT);
                } else {
                    FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) nameTextView[1].getLayoutParams();
...
//            }
        ...
        if (listView == null || prevRowsCount > rowCount || listContentHeight != 0 && listContentHeight + actionBarHeight + AndroidUtilities.dp(EXTRA_HEIGHT) < listView.getMeasuredHeight()) {
                    ...
                    view = new View(mContext) {
                        ...
                        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                            ...
                            if (n == listAdapter.getItemCount()) {
                                ...
                                if (paddingHeight > AndroidUtilities.dp(EXTRA_HEIGHT)) {
                                    paddingHeight = 0;
                                }
                                if (paddingHeight <= 0) {
                                    paddingHeight = 0;
    ...
    private void saveScrollPosition() {
        if (listView != null && layoutManager != null && listView.getChildCount() > 0 && !savedScrollToSharedMedia) {
            ...
            if (view != null) {
                ...
                if (savedScrollPosition == 0 && !allowPullingDown && savedScrollOffset > AndroidUtilities.dp(EXTRA_HEIGHT)) {
                    savedScrollOffset = AndroidUtilities.dp(EXTRA_HEIGHT);
                }
        ...
        contactAddActivity.setDelegate(() -> {
            ...
            if (sharedMediaRow == -1) {
                if (isInLandscapeMode || AndroidUtilities.isTablet()) {
                    ...
                    int paddingBottom = Math.max(0, fragmentView.getMeasuredHeight() - (contentHeight + AndroidUtilities.dp(EXTRA_HEIGHT) + actionBarHeight));
...
//        }
    ...
    public ShowDrawable getShowStatusButton() {
        if (showStatusButton == null) {
            ...
            showStatusButton.setAlpha((int) (0xFF * Math.min(1f, extraHeight / AndroidUtilities.dp(EXTRA_HEIGHT))));
            showStatusButton.setBackgroundColor(ColorUtils.blendARGB(Theme.multAlpha(Theme.adaptHSV(actionBarBackgroundColor, +0.18f, -0.1f), 0.5f), 0x23ffffff, currentExpandAnimatorValue));
        }
    ...
    private boolean editRow(View view, int position) {
        ...
        if (position == bizHoursRow) {
            ...
            itemOptions.add(R.drawable.msg_edit, getString(R.string.ProfileLocationEdit), () -> {
                presentFragment(new org.telegramIunzhakov.ui.Business.LocationActivity());
            });
