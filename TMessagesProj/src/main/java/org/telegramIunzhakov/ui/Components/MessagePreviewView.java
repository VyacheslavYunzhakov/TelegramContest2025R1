...
import org.telegramIunzhakov.messenger.ChatMessageSharedResources;
...
import org.telegramIunzhakov.messenger.MessagePreviewParams;
...
//                sendMessagesView.setOnClickListener(View -> didSendPressed());
            ...
            if (textSelectionOverlay != null) {
                ...
                addView(textSelectionOverlay, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.MATCH_PARENT, Gravity.TOP | Gravity.LEFT, 0, org.telegramIunzhakov.ui.ActionBar.ActionBar.getCurrentActionBarHeight() / AndroidUtilities.density, 0, 0));
            }
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            ((MarginLayoutParams) chatListView.getLayoutParams()).topMargin = org.telegramIunzhakov.ui.ActionBar.ActionBar.getCurrentActionBarHeight();
            if (isLandscapeMode) {
