...
public class BlurringShader {
    ...
    public void draw(float[] oesMatrix, int texture, int textureWidth, int textureHeight) {
        ...
        org.telegramIunzhakov.ui.Components.Paint.Shader.SetColorUniform(p.gradientTopHandle, gradientTop);
        org.telegramIunzhakov.ui.Components.Paint.Shader.SetColorUniform(p.gradientBottomHandle, gradientBottom);
