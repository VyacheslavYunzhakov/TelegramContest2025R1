...
import org.telegramIunzhakov.messenger.MrzRecognizer;
...
import org.telegramIunzhakov.messenger.SecureDocumentKey;
...
import org.telegramIunzhakov.ui.Cells.TextDetailSettingsCell;
...
import org.telegramIunzhakov.ui.Components.HintEditText;
    ...
    private void createIdentityInterface(final Context context) {
        ...
        if (currentDocumentsType != null) {
            ...
            scanDocumentCell.setOnClickListener(v -> {
                ...
                CameraScanActivity fragment = new CameraScanActivity(org.telegramIunzhakov.ui.CameraScanActivity.TYPE_MRZ);
