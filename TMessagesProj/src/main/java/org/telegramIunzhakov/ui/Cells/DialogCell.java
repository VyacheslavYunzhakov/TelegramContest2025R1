...
import org.telegramIunzhakov.messenger.CodeHighlighting;
...
import org.telegramIunzhakov.ui.Components.BubbleCounterPath;
...
import org.telegramIunzhakov.ui.Components.DialogCellTags;
...
import org.telegramIunzhakov.ui.Components.PhotoBubbleClip;
...
import org.telegramIunzhakov.ui.RightSlidingDialogContainer;
        ...
        if (message != null && message.messageOwner != null && message.messageOwner.media instanceof TLRPC.TL_messageMediaPaidMedia) {
            ...
            for (int i = 0; i < Math.min(3, groupMessages.size()); ++i) {
                ...
                if (message != null && !message.needDrawBluredPreview() && (message.isPhoto() || message.isNewGif() || message.isVideo() || message.isRoundVideo() || message.isStoryMedia())) {
                    ...
                    if (!("app".equals(type) || "profile".equals(type) || "article".equals(type) || type != null && type.startsWith("telegramIunzhakov_"))) {
                        setThumb(i, message);
                    }
                }
            }
