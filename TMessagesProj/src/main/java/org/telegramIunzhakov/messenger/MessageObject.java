...
import org.telegramIunzhakov.messenger.ringtone.RingtoneDataStore;
...
import org.telegramIunzhakov.ui.Business.QuickRepliesController;
...
import org.telegramIunzhakov.ui.Components.Forum.ForumBubbleDrawable;
import org.telegramIunzhakov.ui.Components.Forum.ForumUtilities;
import org.telegramIunzhakov.ui.Components.QuoteSpan;
...
import org.telegramIunzhakov.ui.Components.TranscribeButton;
import org.telegramIunzhakov.ui.Components.TypefaceSpan;
import org.telegramIunzhakov.ui.Components.URLSpanBotCommand;
import org.telegramIunzhakov.ui.Components.URLSpanBrowser;
import org.telegramIunzhakov.ui.Components.URLSpanMono;
import org.telegramIunzhakov.ui.Components.URLSpanNoUnderline;
import org.telegramIunzhakov.ui.Components.URLSpanNoUnderlineBold;
...
import org.telegramIunzhakov.ui.PeerColorActivity;
...
//        }
    ...
    public int getMaxMessageTextWidth() {
        ...
        } else if (getMedia(messageOwner) instanceof TLRPC.TL_messageMediaWebPage && getMedia(messageOwner).webpage != null && "telegramIunzhakov_background".equals(getMedia(messageOwner).webpage.type)) {
            try {
...
//        }
    ...
    public boolean isWallpaper() {
        return getMedia(messageOwner) instanceof TLRPC.TL_messageMediaWebPage && getMedia(messageOwner).webpage != null && "telegramIunzhakov_background".equals(getMedia(messageOwner).webpage.type);
    }

    public boolean isTheme() {
        return getMedia(messageOwner) instanceof TLRPC.TL_messageMediaWebPage && getMedia(messageOwner).webpage != null && "telegramIunzhakov_theme".equals(getMedia(messageOwner).webpage.type);
    }
    ...
    public TLRPC.WebPage getStoryMentionWebpage() {
        ...
        webpage.type = "telegramIunzhakov_story";
...
//            span.setScale(.7f, .7f);
    ...
    public boolean hasLinkMediaToMakeSmall() {
        ...
        return hasLinkPreview && !isGiveawayOrGiveawayResults() &&
            ...
            !"telegramIunzhakov_megagroup".equals(webpageType) &&     // drawInstantViewType = 2
            !"telegramIunzhakov_background".equals(webpageType) &&    // drawInstantViewType = 6
            !"telegramIunzhakov_voicechat".equals(webpageType) &&     // drawInstantViewType = 9
            !"telegramIunzhakov_videochat".equals(webpageType) &&
            !"telegramIunzhakov_livestream".equals(webpageType) &&    // drawInstantViewType = 11
            !"telegramIunzhakov_user".equals(webpageType) &&          // drawInstantViewType = 13
            !"telegramIunzhakov_story".equals(webpageType) &&         // drawInstantViewType = 17
            !"telegramIunzhakov_channel_boost".equals(webpageType) && // drawInstantViewType = 18
            !"telegramIunzhakov_group_boost".equals(webpageType) &&   // drawInstantViewType = 21
            !"telegramIunzhakov_chat".equals(webpageType)
        ;
    }
    ...
    public boolean isLinkMediaSmall() {
        ...
        return !(webpage != null && TextUtils.isEmpty(webpage.description) && TextUtils.isEmpty(webpage.title)) && (
                ...
                "article".equals(webpageType) || "telegramIunzhakov_bot".equals(webpageType) ||
                "telegramIunzhakov_user".equals(webpageType) || "telegramIunzhakov_channel".equals(webpageType) ||
                "telegramIunzhakov_megagroup".equals(webpageType) || "telegramIunzhakov_voicechat".equals(webpageType) || "telegramIunzhakov_videochat".equals(webpageType) ||
                "telegramIunzhakov_livestream".equals(webpageType) || "telegramIunzhakov_channel_boost".equals(webpageType) || "telegramIunzhakov_group_boost".equals(webpageType) ||
                "telegramIunzhakov_chat".equals(webpageType)
        );
    }
